...
public class OxygenProducer {
    ...
    public Oxygen orderOxygen(LocalDate orderDate, OxygenGrade grade, int requiredQuantity, int totalQuantity, int storageQuantity, SortedMap<LocalDate, OxygenDateHistory>  history) throws NotEnoughTimeException {
