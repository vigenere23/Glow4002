...
public class ProgramUseCase {
    ...
    public ProgramUseCase(TransportReserver transportReserver, OxygenReserver oxygenReserver, ArtistRepository artistRepository, PassRepository passRepository, PassCounter passCounter) {
    ...
    private int countFestivalAttendeesForOneDay(LocalDate eventDate) {
        return passCounter.countFestivalAttendeesForOneDay(passRepository.findAll(), eventDate);
    }
}