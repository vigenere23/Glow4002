...
public class BookingServer implements Runnable {
    ...
    private ResourceConfig setupResourceConfig() {
        ...
        OxygenProducer oxygenProducer = new OxygenProducer(oxygenFactory, oxygenInventoryRepository, oxygenHistoryRepository);
        ...
        PassOrderUseCase passOrderUseCase = new PassOrderUseCase(passOrderFactory, passOrderRepository, transportReserver, oxygenProducer);
