...
public class BookingServer implements Runnable {
    ...
    private ResourceConfig setupResourceConfig() {
        ...
        PassOrderUseCase passOrderUseCase = new PassOrderUseCase(passOrderFactory, passOrderRepository, transportReservation, shuttleRepository, oxygenReserver, oxygenInventoryRepository, oxygenHistoryRepository);
