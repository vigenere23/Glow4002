...
public class OxygenFactoryTests {
	...
	private OxygenFactory oxygenFactory;
	 ...
	 @Test
	 public void given_orderOxygen_when_defaultTemplate_then_oneItenIsAdded() {
		 orderGradeAndAssertInventory(OxygenGrade.A, 1);
	 }
	 
	 @Test
	 public void when_orderOxygenTwice_then_correspondingQuantityIsAdded() {
	 ...
	 @Test
	 public void given_setOneTemplate_when_orderOxugen_then_correspopndingQuantityIsAdded() {
	 ...
	 @Test
	 public void given_setMultiTemplate_when_orderOxugen_then_correspopndingQuantityIsAdded() {
		 EnumMap<OxygenGrade, Integer> expectedQuantity = new EnumMap<OxygenGrade, Integer>(OxygenGrade.class);
		 expectedQuantity.put(OxygenGrade.A, 10);
		 ...
		 oxygenFactory.setTemplatedOxygenOrder(expectedQuantity);
		 orderGradeAndAssertInventory(OxygenGrade.A, 10);
		 orderGradeAndAssertInventory(OxygenGrade.B, 2);
		 orderGradeAndAssertInventory(OxygenGrade.E, 5);
	 }
